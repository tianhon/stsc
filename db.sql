...
CREATE TABLE IF NOT EXISTS `article` (
  ...
  `Content` varchar(60000) DEFAULT NULL COMMENT '如果URL为空则以标准方式显示文本内容',
...
CREATE TABLE IF NOT EXISTS `classification` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Name` int(11) NOT NULL COMMENT '类别名称',
...
-- Dumping structure for table stsc.even
...
CREATE TABLE IF NOT EXISTS `even` (
  ...
  `Description` varchar(2000) DEFAULT NULL COMMENT '活动简介',
  `HomeUrl` varchar(100) NOT NULL COMMENT '活动页面URL 可以是自定义页面 或者标准模板页面',
  `Param` varchar(2000) DEFAULT NULL COMMENT '参数, json对象格式 ',
...
CREATE TABLE IF NOT EXISTS `goods` (
  ...
  `ThumbImg` varchar(50) NOT NULL COMMENT '商品缩略图',
  `ShortDescription` varchar(200) DEFAULT NULL COMMENT '商品简介',
  `Description` varchar(60000) DEFAULT NULL COMMENT '商品详情',
...
CREATE TABLE IF NOT EXISTS `goods_img` (
  ...
  `ImgPath` varchar(50) DEFAULT '0' COMMENT '图片路径',
  PRIMARY KEY (`Id`),
  KEY `GoodsId` (`GoodsId`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `order` (
  ...
  `AddressId` varchar(50) DEFAULT NULL COMMENT '收件人收货地址Id',
...
CREATE TABLE IF NOT EXISTS `order_detail` (
  ...
  `Price` float NOT NULL COMMENT '商品单价',
  `Count` int(11) NOT NULL DEFAULT '0' COMMENT '商品数量',
  `ThumbImg` varchar(50) DEFAULT NULL COMMENT '缩略图路径',
  PRIMARY KEY (`Id`),
  KEY `OrderId` (`OrderId`),
  KEY `StoreId` (`StoreId`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `store` (
  ...
  `ThumbImg` varchar(100) DEFAULT NULL COMMENT '缩略图路径',
  `Img` varchar(100) DEFAULT NULL COMMENT '宣传图片路径',
  `Description` varchar(2000) DEFAULT NULL COMMENT '店铺简介',
  `HomeUrl` varchar(100) DEFAULT NULL COMMENT '店铺页面URL 可以是自定义页面 或者标准模板页面',
  `Param` varchar(100) DEFAULT NULL COMMENT '参数, json对象格式， 传入homeURL页面'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `user_favorite` (
  ...
  `ThumbImg` varchar(100) DEFAULT NULL COMMENT '缩略图',
...
CREATE TABLE IF NOT EXISTS `user_points` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='用户积分记录';
