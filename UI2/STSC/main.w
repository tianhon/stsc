                    ...
                    <div component="$UI/system/components/justep/list/list"
                      ...
                      <ul class="x-list-template" xid="listTemplateUl2"> 
                        <li xid="li3" class="col col-xs-6 tb-twoColList">
                          ...
                          <img src="" alt="" xid="image1" class="img-responsive media-object" bind-attr-src=' val("imgUrl")' /><div xid="div15" style="background-color:white;"><span xid="span12" class="text-black" bind-text='val("title")'></span></div><div xid="div13" style="background-color:white;"><span xid="span10" bind-text='"¥" + val("price")' class="text-danger"></span>
  <a xid="a2" class="pull-right"><![CDATA[+]]></a></div>
  </div>
                        </li>
                      </ul> 
                    </div>
